...
Every page has been checked with the [W3C Nu HTML Checker](https://validator.w3.org/nu/) and returns no errors or warnings. Evidence is recorded on each student's validation page.
